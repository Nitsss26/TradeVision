        ...
        <footer className="bg-zinc-950 border-t border-zinc-800 pt-16 pb-8 px-4 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-zinc-800 gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        <a href="#" className="text-zinc-600 hover:text-blue-400 transition-colors"><Facebook className="w-5 h-5" /></a>
                        <a href="#" className="text-zinc-600 hover:text-blue-400 transition-colors"><Twitter className="w-5 h-5" /></a>
                        <a href="#" className="text-zinc-600 hover:text-blue-400 transition-colors"><Linkedin className="w-5 h-5" /></a>
                        <a href="#" className="text-zinc-600 hover:text-blue-400 transition-colors"><Instagram className="w-5 h-5" /></a>
                        <a href="#" className="text-zinc-600 hover:text-blue-400 transition-colors"><Youtube className="w-5 h-5" /></a>
                    </div>
                </div>
            </div>
        </footer>
